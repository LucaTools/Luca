...
/// For example, a skill named `swift-concurrency` may contain:
/// - `relativePath: "SKILL.md"`, the skill definition
/// - `relativePath: "resources/glossary.md"`, an auxiliary resource
public struct SkillFile: Equatable, Sendable {
    /// The path of this file relative to the skill's root directory.
    ///
    /// For example `"SKILL.md"` or `"resources/glossary.md"`.
